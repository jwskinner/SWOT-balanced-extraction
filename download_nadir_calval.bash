#!/bin/bash
# This script downloads all of the Nadir CalVal data to a specified location
#
# Requirements 
...
for i in $(seq 474 577); do
    ...
    podaac-data-downloader -c SWOT_L2_NALT_GDR_SSHA_2.0 -d "$DOWNLOAD_LOCATION" --cycle $i
    if [ $? -eq 0 ]; then
