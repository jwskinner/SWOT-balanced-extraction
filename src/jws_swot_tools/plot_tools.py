...
def plot_grids(karin, nadir):
    ...
    plt.scatter(nadir.x_km, nadir.y_km, s=0.01)
    plt.scatter(karin.x_km, karin.y_km, s=0.01)

    plt.figure(figsize=(6, 3), dpi=150)
    plt.scatter(karin.y_obs_grid*1e-3, karin.x_obs_grid*1e-3, s=5, alpha=0.5, label = "KaRIn obs")
    plt.scatter(karin.y_grid*1e-3, karin.x_grid*1e-3, s=1, alpha=0.5,label = "Full Grid")
    plt.scatter(nadir.y_grid*1e-3, nadir.x_grid*1e-3, s=1, alpha=1.0, label = "Nadir obs")
